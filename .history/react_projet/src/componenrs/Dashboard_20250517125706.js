...
import { FiUser, FiUsers, FiFileText, FiBuilding, FiSearch, FiClipboard } from 'react-icons/fi';
    ...
    <section className="bg-white p-5 rounded-2xl shadow-md mt-6 flex flex-col md:flex-row gap-6">
      ...
      <div className="md:flex-1 min-w-[300px] max-w-full">
        <h3 className="text-lg font-semibold mb-3 text-indigo-700 flex items-center gap-2 select-none">
          <FiBuilding className="text-xl" /> Stages par Entreprise
        </h3>
      ...
      <div className="md:flex-1 flex flex-col max-w-full">
        <h3 className="text-lg font-semibold mb-3 text-indigo-700 select-none flex items-center gap-2">
        ...
        <div className="relative w-full max-w-md mb-4">
          ...
          <input
            ...
            className="pl-9 p-2 border border-gray-300 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-indigo-400 transition text-sm"
            value={searchTerm}
