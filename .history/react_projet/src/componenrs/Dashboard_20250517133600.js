...
const Dashboard = () => {
  ...
  const generatePDF = (row) => {
    ...
    // Ajout du thème du projet principal confié à l'étudiant(e)
    if (stage?.description) {
      const themeLabel = "THEME DU PROJET PRINCIPAL CONFIE A L'ETUDIANT(E) :";
      const themeValue = doc.splitTextToSize(stage.description, 160);
      doc.setFont("helvetica", "bold").text(themeLabel, 20, 80);
      doc.setFont("helvetica", "normal").text(themeValue, 20, 88);
    }
