...
// Texte avec 'bold'  
doc.setFont("bold"); // Met la police en gras  
doc.text("NA :", 20, 140);  
doc.setFont("normal"); // Retourne à la police normale  
doc.text(" Non applicable - La compétence n'a pas été mise en œuvre, ou très peu.", 40, 140);  

// Ajout d'un espace  
doc.text("", 20, 150); // Espace  
doc.setFont("bold"); // Met la police en gras  
doc.text("Débutant :", 20, 160);  
doc.setFont("normal"); // Retourne à la police normale  
doc.text(" Applique les connaissances avec assistance.", 40, 160);  

// Ajout d'un espace  
doc.text("", 20, 170); // Espace  
doc.setFont("bold");  
doc.text("Débutant :", 20, 180);  
doc.setFont("normal");  
doc.text(" Met en œuvre les pratiques de manière indépendante.", 40, 180);  

// Ajout d'un espace  
doc.text("", 20, 190); // Espace  
doc.setFont("bold");  
doc.text("Autonome + :", 20, 200);  
doc.setFont("normal");  
doc.text(" Résout des problèmes en fonction du contexte professionnel -", 40, 200);  
