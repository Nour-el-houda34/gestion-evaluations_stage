...
const Dashboard = () => {  
  return (  
    <div className="min-h-screen bg-gray-50 p-8 space-y-16">  
      {/* Hero Section */}  
      <section className="relative flex flex-col items-center justify-center p-4 bg-gradient-to-r from-indigo-600 via-blue-500 to-teal-400 rounded-xl shadow-lg text-white">  
