    ...
    <div className="max-w-3xl mx-auto p-6 bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl shadow-2xl">
      ...
      <div className="mb-6 bg-white rounded-lg shadow p-4">
        ...
        <ul className="list-disc pl-6 text-gray-700 text-sm space-y-1">
          ...
          <li>
            <span className="font-bold">AUTONOME +</span> : Résout des problèmes selon la situation de travail - A un jugement critique pour anticiper ou s'adapter
          </li>
        </ul>
      </div>
                ...
                onClick={() => {
                  ...
                  const doc = new jsPDF();
                          ...
                          doc.setTextColor(0, 0, 0);
                            ...
                            { label: "Email de Stagiaire :", value:`${payload.stagiaire.email}`  },
                            ...
                            { label: "Email de Tuteur :", value: `${payload.tuteur.email}` },
