      ...
      <section className="bg-white p-6 rounded-3xl shadow-2xl">  
        ...
        <table className="min-w-full table-auto border-collapse border border-gray-200 rounded-lg shadow-sm">  
          <thead className="bg-gray-100">  
            <tr>  
              <th className="px-4 py-2 border-b">Stagiaire</th>  
              <th className="px-4 py-2 border-b">Email</th>  
              <th className="px-4 py-2 border-b">Tuteur</th>  
              <th className="px-4 py-2 border-b">Entreprise</th>  
              <th className="px-4 py-2 border-b">Date Début</th>  
              <th className="px-4 py-2 border-b">Date Fin</th>  
          ...
          <tbody>  
            {filteredStagiaires.map((stagiaire, index) => (
              <React.Fragment key={index}>
                <TableRow stagiaire={stagiaire} />
                <tr>
                  <td colSpan="7" className="text-center py-2">
                    <button
                      onClick={() => stagiaire.periodes[0]?.appreciations[0] && stagiaire.periodes[0].appreciations[0].tuteur && stagiaire.periodes[0].appreciations[0].tuteur.downloadPDF()}
