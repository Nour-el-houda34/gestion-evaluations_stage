...
return (  
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-200 p-8 space-y-16">  
        {/* Hero Section */}  
        <section className="relative flex flex-col items-center justify-center p-6 bg-gradient-to-r from-purple-600 via-pink-500 to-red-400 rounded-3xl shadow-2xl text-white">  
            <div className="relative z-10 text-center space-y-4">  
                <h1 className="text-4xl font-extrabold animate-fade-in">Bienvenue dans votre Espace d'Évaluation ✨</h1>  
                <p className="text-lg leading-relaxed animate-fade-in delay-200">  
                    Cliquez ci-dessous pour commencer votre évaluation magique !  
                </p>  
                <Link to="/formulaire" className="mt-40 px-6 py-3 bg-white text-gray-800 font-bold rounded-full shadow-lg hover:bg-gray-300 hover:shadow-xl transition-all duration-300" aria-label="Commencer l'Évaluation">  
                    🚀 Commencer l'Évaluation  
                </Link>  
            </div>  
            <div className="absolute inset-0 bg-gradient-to-r from-purple-600 via-pink-500 to-red-400 opacity-50 rounded-3xl blur-lg"></div>  
        </section>  
