...
const StepOne = ({ nextStep, handleChange, data }) => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-semibold text-center mb-6 text-gray-800">Appréciation du Tuteur de Stage</h2>

      <div className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Nom du stagiaire</label>
            <input
              type="text"
              name="nomStagiaire"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Prénom du stagiaire</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Prénom du tuteur</label>
            <input
              type="text"
              name="prenomTuteur"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Entreprise du tuteur</label>
            <input
              type="text"
        ...
        <div className="grid grid-cols-1 gap-6">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Thème du projet principal</label>
            <textarea
              name="description"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Objectifs assignés</label>
            <textarea
              name="objectif"
      ...
      <div className="flex justify-end mt-4">
        <button
          onClick={handleNext}
          className="px-6 py-2 rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:ring focus:ring-blue-300"
        >
          Suivant
        </button>
      </div>
