...
const StepThree = ({ nextStep, prevStep, handleChange, data }) => {
  ...
  const handleSubmit = async () => {
    ...
    if (
      ...
      setModalMessage("Veuillez remplir toutes les informations nécessaires concernant stagiare et stage.");
      setModalType('error');
      setIsModalOpen(true);
      return;
    }
                ...
                onClick={() => {
                  ...
                  const doc = new jsPDF();
                          ...
                          doc.setTextColor(0, 0, 0);
                            ...
                            { label: "THEME DU PROJET PRINCIPAL CONFIE A L'ETUDIANT(E) :", value: doc.splitTextToSize(payload.stage.description, 160).join("\n") },
                            ];
