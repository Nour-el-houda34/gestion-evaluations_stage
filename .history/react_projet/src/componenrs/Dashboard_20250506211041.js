  ...
  <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-200 p-4 space-y-8">  
    ...
    <table className="w-full table-auto border-collapse">  
      ...
      <tr className="bg-purple-100 text-purple-800">  
        ...
        <th className="px-2 py-1 text-left border">Fiche d'Évaluation</th>  
      </tr>  
      </thead>  
      <tbody>  
      {STAGES_EN_ATTENTE.map((stagiaire, index) => (  
        ...
        <td className="px-4 py-3">{stagiaire.name}</td>  
        <td className="px-4 py-3">{stagiaire.email || "N/A"}</td>  
        <td className="px-4 py-3">{stagiaire.entreprise || "N/A"}</td>  
        <td className="px-4 py-3">{stagiaire.start || "N/A"}</td>  
        <td className="px-4 py-3">{stagiaire.end}</td>  
        <td className="px-4 py-3 text-center">  
          <a  
          href={`/telecharger-fiche/${stagiaire.id}`}  
