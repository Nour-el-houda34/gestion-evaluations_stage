  ...
  doc.text(" Met en œuvre les pratiques de manière indépendante.", 60, 160);  
    ...
    doc.text(" Résout des problèmes en fonction du contexte professionnel -", 60, 170);  
        ...
        payload.appreciation.competences.forEach((competence) => {  
          ...
          yPosition += rowHeight + 5;  // More space below title  
          ...
          yPosition += rowHeight + 5; // More space after headers  
          doc.setFont("helvetica", "normal");  
          doc.setTextColor(0, 0, 0);   
          ...
          competence.categories.forEach((subcat) => {  
              ...
              // Check the length of the evaluation string to adjust spacing  
              const evaluationXPosition = 150;   
              doc.text(subcat.valeur.toString(), evaluationXPosition, yPosition);  
              
              yPosition += rowHeight + 5; // Add additional space between rows   
