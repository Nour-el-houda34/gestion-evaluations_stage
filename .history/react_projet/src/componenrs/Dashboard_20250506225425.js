          ...
          <table className="w-full table-auto border-collapse border border-gray-300">
            <thead>
              <tr className="bg-purple-100 text-purple-800">
                <th className="px-4 py-3 border border-gray-300">Nom Complet</th>
                <th className="px-4 py-3 text-left border border-gray-300">Email</th>
                <th className="px-4 py-3 text-left border border-gray-300">Tuteur</th>
                <th className="px-4 py-3 text-left border border-gray-300">Entreprise</th>
                <th className="px-4 py-3 text-left border border-gray-300">Date Début</th>
                <th className="px-4 py-3 text-left border border-gray-300">Date Fin</th>
              </tr>
            </thead>
            <tbody>
