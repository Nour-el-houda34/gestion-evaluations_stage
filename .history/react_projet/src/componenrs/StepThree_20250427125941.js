...
doc.text("Débutant :", 20, 150);  
 doc.setFont("helvetica", "normal"); // Retourne à la police normale  
doc.text(" Applique les connaissances avec assistance.", 50, 150);  

     doc.setFont("helvetica", "bold").setFontSize(14); // Met la police en gras  
  doc.text("Débutant :", 20, 160);  
   doc.setFont("helvetica", "normal"); // Retourne à la police normale  
  doc.text(" Met en œuvre les pratiques de manière indépendante.", 50, 160);  

     doc.setFont("helvetica", "bold").setFontSize(14); // Met la police en gras  
  doc.text("Autonome + :", 20, 170);  
   doc.setFont("helvetica", "normal"); // Retourne à la police normale  
  doc.text(" Résout des problèmes en fonction du contexte professionnel -", 50, 170);  
