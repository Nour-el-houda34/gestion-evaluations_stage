...
const StepOne = ({ nextStep, handleChange, data }) => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-8 bg-gradient-to-r from-indigo-100 via-purple-100 to-pink-100 rounded-lg shadow-2xl">
      <h2 className="text-3xl font-semibold text-center mb-8 text-gray-700">APPRECIATION DU TUTEUR DE STAGE </h2>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <label className="block text-sm font-medium text-gray-600 mb-2">Thème du projet principal</label>
            <textarea
              name="description"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-600 mb-2">Objectifs assignés</label>
            <textarea
              name="objectif"
