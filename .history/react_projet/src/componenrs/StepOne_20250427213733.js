...
const StepOne = ({ nextStep, handleChange, data }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto p-4 bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl shadow-2xl">
      <h2 className="text-2xl font-extrabold text-center mb-4 text-blue-800">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
          ...
          <div>
            <label className="block text-xs font-semibold text-gray-700 mb-1">Nom du stagiaire</label>
            <input
              type="text"
              name="nomStagiaire"
              value={localData.nomStagiaire}
              onChange={handleInputChange}
              className="input w-full p-1 rounded-lg border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500 shadow-sm"
            />
          </div>
          <div>
            <label className="block text-xs font-semibold text-gray-700 mb-1">Prénom du stagiaire</label>
            <input
              type="text"
          ...
          <div className="col-span-2 grid grid-cols-1 sm:grid-cols-3 gap-2">
            <div>
              <label className="block text-xs font-semibold text-gray-700 mb-1">Nom du tuteur</label>
              <input
                type="text"
                name="nomTuteur"
            ...
            <div>
              <label className="block text-xs font-semibold text-gray-700 mb-1">Prénom du tuteur</label>
              <input
                type="text"
                name="prenomTuteur"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
          <div>
            <label className="block text-xs font-semibold text-gray-700 mb-1">Thème du projet principal</label>
            <textarea
              name="description"
              value={localData.description}
              onChange={handleInputChange}
              className="textarea w-full p-1 rounded-lg border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500 shadow-sm"
              rows="3"
            />
          </div>
          <div>
            <label className="block text-xs font-semibold text-gray-700 mb-1">Objectifs assignés</label>
            <textarea
              name="objectif"
      ...
      <div className="flex justify-end mt-4">
        <button
          onClick={handleNext}
          className="px-6 py-2 rounded-lg text-white font-bold bg-blue-600 hover:bg-blue-700 transition-all duration-200 shadow-lg"
        >
          Suivant
        </button>
      </div>
