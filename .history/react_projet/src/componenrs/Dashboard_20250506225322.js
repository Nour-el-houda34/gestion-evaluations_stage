          ...
          <table className="w-full table-auto border-collapse border border-gray-300">
            <thead>
              <tr className="border-b hover:bg-gray-50 transition-colors duration-300">
                <th className="px-4 py-2 text-left border border-gray-300">Nom Complet</th>
                ...
                <th className="px-4 py-2 text-left border border-gray-300">Date Début</th>
                <th className="px-4 py-2 text-left border border-gray-300">Date Fin</th>
              </tr>
            </thead>
            <tbody>
