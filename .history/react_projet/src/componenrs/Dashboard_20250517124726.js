...
const Dashboard = () => {
 ...
 return (
  <div className="min-h-screen bg-gray-50 p-6 space-y-8 max-w-7xl mx-auto">
    ...
    <section className="bg-white p-5 rounded-2xl shadow-md mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
      {/* Bar chart à gauche */}
      <div>
  ...
  <input
    ...
    className="mb-4 p-2 border border-gray-300 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-indigo-400 transition text-sm"
    value={searchTerm}
  ...
  <div>
    <DataTable
      ...
      customStyles={{
        ...
        rows: {
          style: {
            minHeight: '32px', // hauteur compacte des lignes
          },
        },
        pagination: {
          style: {
