...
return (  
    ...
    <div className="relative z-10 text-center space-y-4">
        ...
        <Link
            to="/formulaire"
            className="px-6 py-2 bg-white text-gray-800 font-bold rounded-full shadow-md hover:bg-gray-200 transition-all duration-300 transform hover:scale-105 mt-20"
        >
            🚀 Lancer
        </Link>
    </div>
