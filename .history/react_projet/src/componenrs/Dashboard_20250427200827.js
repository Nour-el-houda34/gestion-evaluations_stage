  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 bg-gray-100 rounded-lg shadow-lg">
      ...
      <div className="bg-white shadow-md p-6 rounded-lg w-full max-w-md text-center">
        <img 
          src="https://www.google.com/url?sa=i&url=https%3A%2F%2Ffr.vecteezy.com%2Fart-vectoriel%2F2416878-bienvenue-illustration-vectorielle&psig=AOvVaw1_bB6B4-XyPpxwXGDJxLFZ&ust=1745867253307000&source=images&cd=vfe&opi=89978449&ved=0CBQQjRxqFwoTCJDatsX0-IwDFQAAAAAdAAAAABAJ" 
