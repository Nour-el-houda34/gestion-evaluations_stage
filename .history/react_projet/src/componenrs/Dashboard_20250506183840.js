    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-200 p-4 space-y-8">
      ...
      <section className="grid grid-cols-1 gap-6">
        <div className="bg-white p-4 rounded-2xl shadow-lg">
          <h3 className="text-lg font-bold mb-2 text-purple-700">Répartition par Critère</h3>
          {loading ? (
            <p>Chargement...</p>
          ) : error ? (
            ...
            statistiques.map((chart, index) => (
              <div key={index} className="mb-8">
                <h4 className="text-md font-semibold text-center mb-2 text-gray-700">{chart.titre}</h4>
