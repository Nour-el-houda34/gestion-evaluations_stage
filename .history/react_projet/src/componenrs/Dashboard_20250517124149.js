  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 space-y-10">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-gradient-to-br from-indigo-500 to-indigo-700 p-8 rounded-xl shadow text-center text-white flex flex-col items-center">
          <div className="mb-2 text-4xl">👨‍🎓</div>
          <h2 className="text-4xl font-extrabold">{totalStagiaires}</h2>
          <p className="text-indigo-100 mt-2">Total Stagiaires</p>
        </div>
        <div className="bg-gradient-to-br from-green-500 to-green-700 p-8 rounded-xl shadow text-center text-white flex flex-col items-center">
          <div className="mb-2 text-4xl">🧑‍💼</div>
          <h2 className="text-4xl font-extrabold">{totalTuteurs}</h2>
          <p className="text-green-100 mt-2">Total Tuteurs</p>
        </div>
        <div className="bg-gradient-to-br from-yellow-400 to-yellow-600 p-8 rounded-xl shadow text-center text-white flex flex-col items-center">
          <div className="mb-2 text-4xl">📄</div>
          <h2 className="text-4xl font-extrabold">{totalStages}</h2>
          <p className="text-yellow-100 mt-2">Total Stages</p>
        </div>
      </section>

      {/* Stages par entreprise amélioré */}
