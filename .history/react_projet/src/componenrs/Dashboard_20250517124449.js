    ...
    <section className="bg-white p-5 rounded-2xl shadow-md mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div className="flex flex-col">
        ...
        <input
          ...
          className="mb-4 p-2 border border-gray-300 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-indigo-400 transition"
          value={searchTerm}
