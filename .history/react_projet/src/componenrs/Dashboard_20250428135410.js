...
const Dashboard = () => {  
  return (  
    <div className="min-h-screen bg-gray-100 p-8 space-y-16">  
      {/* Hero Section */}  
<section className="relative flex flex-col items-center justify-center p-4 bg-gradient-to-br from-purple-700 via-indigo-600 to-blue-500 text-white overflow-hidden">  
