  ...
  const handleNextCategory = () => {
   ...
   return (
    <div className="max-w-3xl mx-auto p-6 bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl shadow-2xl">
      ...
      >
        <div className={`bg-white rounded-lg shadow-lg p-8 max-w-md w-full text-center ${modalType === 'error' ? 'border-red-400' : 'border-green-400'}`}>
          <h2 className={`text-2xl font-bold mb-4 ${modalType === 'error' ? 'text-red-600' : 'text-green-600'}`}>
