...
const StepOne = ({ nextStep, handleChange, data }) => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-8 bg-white rounded-lg shadow-md">
      <h2 className="text-3xl font-semibold text-center mb-8 text-blue-600">Appréciation du Tuteur de Stage</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div>
            ...
            <input
              ...
              className="input w-full p-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <textarea
              ...
              onChange={handleInputChange}
              className="textarea w-full p-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
              rows="4"
            />
          </div>
      ...
      <div className="flex justify-end mt-8">
        <button
          onClick={handleNext}
          className="px-6 py-3 rounded-lg text-white font-semibold bg-blue-600 hover:bg-blue-700 transition-colors duration-300 shadow-md"
        >
          Suivant
        </button>
      </div>
