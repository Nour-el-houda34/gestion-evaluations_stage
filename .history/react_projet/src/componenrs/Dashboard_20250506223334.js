  ...
  <>
    {stagiaire.periodes.map((periode, index) => (
      <tr key={index} className="border-b hover:bg-gray-50 transition-colors duration-300">
        ...
        <td className="px-4 py-3">{stagiaire.periodes.appreciations.tuteur ? `${stagiaire.periodes.appreciations.tuteur.nom} ${stagiaire.periodes.appreciations.tuteur.nom}` : 'Non renseigné'}</td> {/* Colonne du tuteur */}
