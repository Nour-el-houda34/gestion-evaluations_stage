...
const Dashboard = () => {
    ...
    const COLORS = ["#6EE7B7", "#93C5FD", "#FDE68A", "#FCA5A5", "#F472B6"];
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-indigo-100 p-8 space-y-16">
            ...
            <section className="grid grid-cols-1 md:grid-cols-4 gap-6">
                {KPI.map((item, index) => (
                    <div key={index} className="bg-gradient-to-br from-white to-indigo-50 p-6 rounded-2xl shadow-lg text-center hover:shadow-2xl transition-shadow duration-300">
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-gradient-to-br from-white to-indigo-50 p-6 rounded-2xl shadow-lg">
            ...
            <section className="bg-gradient-to-br from-white to-indigo-50 p-6 rounded-2xl shadow-lg">
