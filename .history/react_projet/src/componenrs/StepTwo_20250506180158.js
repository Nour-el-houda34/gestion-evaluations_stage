    ...
    <div className="max-w-3xl mx-auto p-6 bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl shadow-2xl">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white p-4 rounded-lg shadow-md">
          <label className="block text-lg font-semibold text-blue-700">Implication dans ses activités :</label>
        ...
        {/* Ouverture */}
        <div className="bg-white p-4 rounded-lg shadow-md">
          <label className="block text-lg font-semibold text-blue-700">Ouverture aux autres :</label>
          <div className="flex flex-wrap gap-4 mt-2">
        ...
        <div className="bg-white p-4 rounded-lg shadow-md">
          <label className="block text-lg font-semibold text-blue-700">Qualité de ses productions :</label>
          <div className="flex flex-wrap gap-4 mt-2">
        ...
        {/* Observations */}
        <div className="bg-white p-4 rounded-lg shadow-md">
          <label className="block text-lg font-semibold text-blue-700">Observations sur l'ensemble du travail accompli :</label>
          <textarea
            name="observations"
            value={observations}
