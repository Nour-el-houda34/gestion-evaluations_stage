  ...
  return (
    <div className="max-w-3xl mx-auto p-8 bg-gradient-to-r from-indigo-100 via-purple-100 to-pink-100 rounded-lg shadow-2xl">
      ...
      <div className="space-y-6">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-600 mb-4">Thème du projet principal</label>
          <textarea
            name="description"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-600 mb-4">Objectifs assignés</label>
          <textarea
            name="objectif"
