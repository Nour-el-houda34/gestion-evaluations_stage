    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-200 p-4 space-y-8">  
        <section className="relative flex flex-col items-center justify-center p-6 bg-gradient-to-r from-purple-800 via-pink-700 to-red-600 rounded-2xl shadow-lg text-white overflow-hidden">  
            <div className="relative z-10 text-center space-y-4">  
                <h1 className="text-3xl font-bold tracking-wide">✨ Bienvenue ✨</h1>  
                <p className="text-sm leading-relaxed max-w-md mx-auto">  
                    Plongez dans une expérience d'évaluation extraordinaire !  
                </p>  
                <Link  
                    to="/formulaire"  
                    className="mt-4 px-6 py-2 bg-white text-gray-800 font-bold rounded-full shadow-md hover:bg-gray-200 transition-all duration-300 transform hover:scale-105"  
                >  
                    🚀 Lancer  
                </Link>  
            </div>  
        ...
        <div className="h-8"></div> {/* Espace entre les sections */}
