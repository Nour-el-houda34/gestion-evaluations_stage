    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-300 p-6 space-y-10">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white p-6 rounded-3xl shadow-lg">
          <h3 className="text-xl font-bold mb-4 text-indigo-700">Répartition par Critère</h3>
          {loading ? (
            ...
            statistiques.map((chart, index) => (
              <div key={index} className="mb-10">
                <h4 className="text-lg font-semibold text-center mb-4 text-gray-700">{chart.titre}</h4>
        ...
        <div className="bg-white p-6 rounded-3xl shadow-lg">
          <h3 className="text-xl font-bold mb-4 text-indigo-700">Compétences</h3>
          {loading ? (
            <p className="text-gray-500">Chargement...</p>
          ) : error ? (
            <p className="text-red-500">Erreur : {error}</p>
