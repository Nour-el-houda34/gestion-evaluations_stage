...
return (
  <div className="min-h-screen bg-gray-50 p-6 space-y-4 max-w-7xl mx-auto">
    ...
    <section className="grid grid-cols-1 sm:grid-cols-3 gap-3">
      {[{
        ...
        <div
          key={i}
          className={`bg-gradient-to-br ${bgFrom} ${bgTo} p-4 rounded-2xl shadow-md text-center text-white flex flex-col items-center transition-transform transform hover:scale-105`}
    ...
    <section className="bg-white p-4 rounded-2xl shadow-md mt-4 flex flex-col md:flex-row gap-4">
      ...
      <div className="md:flex-1 min-w-[300px] max-w-full">
        <h3 className="text-lg font-semibold mb-2 text-blue-700 flex items-center gap-2 select-none">
      ...
      <div className="md:flex-1 flex flex-col max-w-full">
        <h3 className="text-lg font-semibold mb-2 text-blue-700 select-none flex items-center gap-2">
          <FiClipboard className="text-xl" /> Liste des Stages
        </h3>
