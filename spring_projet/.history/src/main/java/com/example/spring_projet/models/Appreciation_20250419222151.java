...
public class Appreciation {
    ...
    public String getQualiteProduction() { return qualiteProduction; }
    public void setQualiteProduction(String qualiteProduction) { this.qualiteProduction = qualiteProduction; }
    public String getObservation() { return observation; }
    public void setObservation(String observation) { this.observation = observation; }
    public List<Evaluation> getEvaluations() { return evaluations; }
    public void setEvaluations(List<Evaluation> evaluations) { this.evaluations = evaluations; }
    public List<CompetenceSpecifique> getCompetencesSpecifiques() { return competencesSpecifiques; }
    public void setCompetencesSpecifiques(List<CompetenceSpecifique> competencesSpecifiques) { this.competencesSpecifiques = competencesSpecifiques; }
}
