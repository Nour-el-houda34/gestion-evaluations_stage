...
private static final Logger logger = LoggerFactory.getLogger(EvaluationController.class);
    ...
    public ResponseEntity<String> submitEvaluation(@RequestBody FormDataDTO formDataDTO) {
        try {
            ...
            // 3. Sauvegarde du tuteur (et récupération de son ID)
            TuteurDTO savedTuteur = tuteurService.save(formDataDTO.getTuteur());
            ...
            // ✅ Ajout du tuteurId ici
            appreciationDTO.setTuteurId(savedTuteur.getId());
            ...
            e.printStackTrace();
            logger.error("Exception détectée dans submitEvaluation", e);
